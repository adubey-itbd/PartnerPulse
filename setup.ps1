...
.DESCRIPTION
    Run this after downloading/extracting the repo zip on a new machine. It will:
      ...
      4. Build every partner's data cache + Grok churn analysis (data\*.json).
      5. Start the local web server and open the portfolio dashboard in your browser.

    API keys (Halo / TeamGPS / Grok via AI_API_KEY) are already baked into extract\config.py,
...
# ---------------------------------------------------------------------------
Write-Step "Building partner data + Grok churn analysis"
